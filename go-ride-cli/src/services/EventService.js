...
export default class EventService {
    ...
    updateLiveEventPictures = (eventId, picture) => this.service.put(`/live/pictures/${eventId}`, {
        picture
    })
    ...
    postAComment = (eventId, comment, id) => this.service.post(`/live/comments/${eventId}/${id}`, {
        comment
    })
    getAllPicturesEvent = (eventId) => this.service.get(`/live/pictures/${eventId}`)
}